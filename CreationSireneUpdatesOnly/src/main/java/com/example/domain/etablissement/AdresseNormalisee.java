...
public class AdresseNormalisee  extends Etablissement {
	...
	public AdresseNormalisee(String l1_normalisee, String l2_normalisee, String l3_normalisee, String l4_normalisee,
			String l5_normalisee, String l6_normalisee, String l7_normalisee) {
		super();
