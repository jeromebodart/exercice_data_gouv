...
public class Etablissement extends Entreprise {
	...
	public String toString() {
		return "Etablissement [SIRET=" + SIRET + ", entreprise=" + entreprise + ", nic=" + nic + ", adressedeclaree="
				+ adressedeclaree + ", adresse_normalisee=" + adresse_normalisee + ", info=" + info
				+ ", adressegeographique=" + adressegeographique + ", localisation=" + localisation + ", economies="
				+ economies + ", mises_a_jour=" + mises_a_jour + "]";
	}
